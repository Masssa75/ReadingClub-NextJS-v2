...
// Audio URLs for letter sounds (local files)
const getLetterAudioUrl = (letter: string) => `/audio/letters/${letter.toLowerCase()}.mp3`;
...
function Learn1() {
  ...
  const playLetterSound = () => {
    ...
    const audioUrl = getLetterAudioUrl(currentLetter);
  ...
  return (
    <div className="fixed inset-0 w-screen h-screen overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full gap-8">
        <div className="text-white text-2xl font-light tracking-[0.3em] uppercase opacity-70">Sound Training</div>
